...
- [ ] Verify it: `/check verify data model` · the label path above needs the real run before it can be verified; the rest of the feature's prior verification stands but predates this milestone
- [ ] Test it: `/test data model` · same reason
